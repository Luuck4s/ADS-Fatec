...
import 'package:app_15/pages/data.dart';
import 'package:app_15/utils/Account.dart';
...
class _HomeState extends State<Home> {
  ...
  void _goToData(BuildContext context) {
    Account conta = new Account(name.text, int.parse(age.text), sexo.toString(), escolaridade.toString(), isBrasileiro, limit);
